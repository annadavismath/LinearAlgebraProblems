...
\begin{document}
\begin{exercise}
Let vectors $\mathcal{B}=\left\{\vec{v}_1, \vec{v}_2\right\}$ be a basis for the plane depicted below.  Find the coordinate vector for $\vec{x}$ with respect to $\mathcal{B}$.
\begin{center}
